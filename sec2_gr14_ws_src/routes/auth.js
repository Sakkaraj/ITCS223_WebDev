/**
 * auth.js — BoonSonClon Authentication Engine
 * Purpose: Manages user lifecycle operations including member/admin registration, 
 * multi-tier login, session logging, and token verification.
 */
 ...
 * Creates a new member account with salted password and returns a JWT.
 */
 ...
 * Validates member credentials and returns a 7-day JWT.
 */
 ...
 * High-security login for administrative staff.
 */
...
/**
 * GET /api/auth/me
 * Helper endpoint to verify JWT validity and reclaim user session state.
 */
