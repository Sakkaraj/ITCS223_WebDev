/**
 * orders.js — BoonSonClon Order Lifecycle
 * Purpose: Manages the checkout process, stock validation, tax/shipping calculation, 
 * and retrieval of member-specific order history.
 */
...
/**
 * POST /api/orders
 * Performs the checkout transaction: validates stock, calculates financials,
 * creates shipping/delivery records, and finalizes the order.
 */
...
/**
 * GET /api/orders/my
 * Returns a list of orders for the authenticated member.
 */
 ...
 * Returns granular details for a specific order owned by the authenticated member.
 */
