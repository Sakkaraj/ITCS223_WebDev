/**
 * products.js — BoonSonClon Product Catalog
 * Purpose: Route handler for product discovery, granular filtering, 
 * metadata retrieval, and administrative inventory management.
 */
...
/**
 * formatImageUrl — URL Sanitization
 * Normalizes image paths for consistent frontend rendering.
...
/**
 * GET /api/products
 * Comprehensive product search with multi-parameter filtering, sorting, and pagination.
 */
 ...
 * Returns aggregated metadata used to populate frontend shopping filters.
 */
 ...
 * Returns all product categories with associated item counts.
 */
 ...
 * Returns the global list of available colors and their hex codes.
 */
 ...
 * Returns the global list of available materials (e.g., Wood, Fabric).
 */
 ...
 * Admin-only: Enters a new color definition into the system.
 */
 ...
 * Admin-only: Creates a new material type.
 */
...
/**
 * GET /api/products/:id
 * Returns a deep hydration object for a single product, including images, 
 * variant colors, and public reviews.
 */
...
/**
 * POST /api/products
 * Admin-only: Creates a new product entry, associates images, and links variant colors.
 */
...
/**
 * PUT /api/products/:id
 * Admin-only: Updates product attributes, handles numeric coercion, 
 * and refreshes image/color associations.
 */
 ...
 * Admin-only: Permanently removes a product and associated metadata (images, colors, reviews).
 */
